...
```javascript
import besselj0By from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-besselj0-by@v0.2.3-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-besselj0-by@v0.2.3-deno/mod.js';
```
